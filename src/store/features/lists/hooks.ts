...
//   Selectors
// -------------------------------------
const selectorActiveUrls = (state: RootState) => state.lists.activeListUrls
const selectorByUrls = (state: RootState) => state.lists.byUrl
...
const combineTokenMaps = (
  lists: RootState['lists']['byUrl'],
  urls: string[]
) => {
...
export const combinedTokenMapFromOfficialsUrlsSelector = createSelector(
  [selectorByUrls],
  (lists) => {
...
export const combinedTokenMapFromUnsupportedUrlsSelector = createSelector(
  [selectorByUrls],
  (lists) => {
...
export const combinedTokenMapFromWarningUrlsSelector = createSelector(
  [selectorByUrls],
  (lists) => {
    // get hard coded unsupported tokens
