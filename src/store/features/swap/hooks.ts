...
//   useEffect(() => {
//     if (!chainId) return
//     const parsed = queryParametersToSwapState(pathname)
...
//   const derivedPairData = useSelector(
//     derivedPairByDataIdSelector({ pairId, timeWindow })
//   )
...
//           dispatch(
//             updatePairData({ pairData: newPairData, pairId, timeWindow })
//           )
//           setIsLoading(false)
//         } else {
...
//     const updatePairId = () => {
//       try {
//         const pairAddress = getLpAddress(
//           token0Address,
//           token1Address
//         )?.toLowerCase()
...
//     pair && pair.chainId === ChainId.MAINNET
...
//         formattedPoolData[pair.liquidityToken.address.toLowerCase()]
//       const oneDay: FormattedPoolFields | undefined =
//         formattedPoolData24h[pair.liquidityToken.address.toLowerCase()]
//       const twoDays: FormattedPoolFields | undefined =
//         formattedPoolData48h[pair.liquidityToken.address.toLowerCase()]
//       const week: FormattedPoolFields | undefined =
//         formattedPoolData7d[pair.liquidityToken.address.toLowerCase()]
//       const twoWeeks: FormattedPoolFields | undefined =
//         formattedPoolData14d[pair.liquidityToken.address.toLowerCase()]
